...
By letting the layout and the element definitions of the page be separate, and the layout reference the content elements instead of the elements referencing the layout,  
it becomes easy to change the layout but keep the content. On the other hand, 
